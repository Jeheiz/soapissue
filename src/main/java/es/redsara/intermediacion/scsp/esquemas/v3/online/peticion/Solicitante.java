 ...
 *       &lt;all&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}IdentificadorSolicitante"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}NombreSolicitante"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}UnidadTramitadora" minOccurs="0"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}Procedimiento" minOccurs="0"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}Finalidad"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}Consentimiento"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}Funcionario" minOccurs="0"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}IdExpediente" minOccurs="0"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
