 ...
 *       &lt;all&gt;
  *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}CodigoEstado" minOccurs="0"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}CodigoEstadoSecundario" minOccurs="0"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}LiteralError" minOccurs="0"/&gt;
 *         &lt;element re="{http://intermediacion.redsara.es/scsp/esquemas/V3/peticion}TiempoEstimadoRespuesta" minOccurs="0"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
